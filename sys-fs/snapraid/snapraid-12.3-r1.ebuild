...
pkg_postinst() {
	chgrp users /var/snapraid.content.lock
	chmod 660 /var/snapraid.content.lock
	elog "To start using SnapRAID, change the example configuration"
	elog "/usr/share/doc/snapraid-12.3-r1/snapraid.conf.example.bz2"
	elog "to fit your needs and copy it to /etc/snapraid.conf"
}
