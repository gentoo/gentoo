...
SRC_URI="
	https://salsa.debian.org/debian/runit/-/raw/3e3ceeebb948d41332a8930594010f44ebd19cd5/debian/patches/0029-fix-ftbfs-with-gcc14.patch -> ${P}-ftbfs-with-gcc14.patch
...
src_prepare() {
	...
	echo ${S}
	cd "${S}"
	eapply -p3 "${DISTDIR}"/${P}-ftbfs-with-gcc14.patch
...
src_install() {
	...
	sed -i 's:/etc/runit/:/run/runit.:g' "${ED}"/etc/runit/{1,3,ctrlaltdel}
