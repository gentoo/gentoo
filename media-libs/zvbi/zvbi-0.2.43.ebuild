...
LICENSE="BSD-2 GPL-2+ LGPL-2+ LGPL-2.1+ MIT"
SLOT="0"
...
PATCHES=(
	# https://github.com/zapping-vbi/zvbi/pull/54.patch
	"${FILESDIR}"/${P}-fix-musl-va_copy.patch
	# https://github.com/zapping-vbi/zvbi/pull/55.patch
	"${FILESDIR}"/${P}-fix-g3-char.patch
)
