...
if [[ "${PV}" != 9999 ]] ; then
	SRC_URI="https://download.sourceforge.net/freetype/${P/_/}.tar.xz
		mirror://nongnu/freetype/${P/_/}.tar.xz
		utils?	( https://download.sourceforge.net/freetype/ft2demos-${PV}.tar.xz
			mirror://nongnu/freetype/ft2demos-${PV}.tar.xz )
		doc?	( https://download.sourceforge.net/freetype/${PN}-doc-${PV}.tar.xz
