...
DESCRIPTION="GTK3 support for libcanberra, the portable sound event library"
HOMEPAGE="https://0pointer.de/lennart/projects/libcanberra/"
SRC_URI="https://0pointer.de/lennart/projects/${PN}/${MY_P}.tar.xz"
S="${WORKDIR}/${MY_P}"
...
multilib_src_install_all() {
	...
	newexe "${FILESDIR}"/${PN}-module.sh 40-${PN}-module
}
