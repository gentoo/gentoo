...
REQUIRED_USE="
	...
	test? ( gtk4 )
	vala? ( gtk4 introspection )
	X? ( gtk4 )
"
REQUIRED_USE+=" gtk4? ( wayland? ( introspection ) )"
#	appindicator? ( dev-libs/libdbusmenu[gtk4?] )
DEPEND="
	app-text/iso-codes
	...
	appindicator? ( dev-libs/libdbusmenu )
	gtk2? ( x11-libs/gtk+:2 )
...
pkg_postinst() {
	...
	use gtk4 && gnome2_query_immodules_gtk4
