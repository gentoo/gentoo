...
IUSE="X +anthy canna curl eb emacs expat libffi gtk gtk3 l10n_ja l10n_ko l10n_zh-CN l10n_zh-TW libedit libnotify libressl m17n-lib ncurses nls qt4 skk sqlite ssl static-libs unicode xft"
RESTRICT="test"
REQUIRED_USE="gtk? ( X )
	gtk3? ( X )
	qt4? ( X )
