...
SRC_URI="
	...
	https://raw.githubusercontent.com/google/material-design-icons/4.0.0/src/action/build/materialicons/24px.svg
		-> ${P}-tool.svg
"
#	ppc64? ( https://github.com/astral-sh/python-build-standalone/releases/download/${CPYTHON_VER#*+}/cpython-${CPYTHON_VER}-ppc64le-unknown-linux-gnu-install_only.tar.gz )
S="${WORKDIR}/${P}/src"
