...
IUSE="doc elogind gnome input_devices_wacom +introspection screencast sound sysprof systemd test udev wayland video_cards_nvidia"
...
DEPEND="
	...
	sound? ( >=media-libs/libcanberra-0.26 )
	sys-apps/dbus
