...
IUSE="+system-libdeflate"

BDEPEND="system-libdeflate? ( virtual/pkgconfig )"
DEPEND="system-libdeflate? ( >=app-arch/libdeflate-1.22:= )"
RDEPEND="${DEPEND}"
