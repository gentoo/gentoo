...
SRC_URI="https://gitlab.com/sane-project/backends/uploads/54f858b20a364fc35d820df935a86478/${P}.tar.gz"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-1.0.27-network.patch"
)

src_prepare() {
	default

	cat >> backend/dll.conf.in <<-EOF || die
	...
	sed -i \
		-e "/by sane-desc 3.5 from sane-backends/s:sane-backends .*:sane-backends ${PV}:" \
