...
# doc/descriptions/pint.desc: Unmaintained and "Haven't been tested for a long time. Handle with care."
IUSE_SANE_BACKENDS=(
	abaton
	agfafocus
	apple
...
IUSE="gphoto2 +jpeg png snmp systemd threads +tiff +usb v4l xinetd +zeroconf"
...
REQUIRED_USE="
	gphoto2? ( jpeg )
	sane_backends_dc210? ( jpeg )
	sane_backends_dc240? ( jpeg )
	sane_backends_dell1600n_net? ( jpeg tiff )
	sane_backends_epsonds? ( jpeg )
	sane_backends_escl? ( jpeg zeroconf )
	sane_backends_kvs40xx? ( threads )
	sane_backends_mustek_usb2? ( threads )
	sane_backends_pixma? ( jpeg )
"

# Build system uses automagic to find libraries
# Some of these are then unconditionally required for some drivers.
# See acinclude.m4 for details
# libxml2: required for escl and --with-usb-record-replay (could be made optional)
RDEPEND="
	acct-user/saned
	acct-group/scanner
...
BDEPEND="
	...
	sys-devel/gettext
	virtual/pkgconfig
	sane_backends_pixma? ( ${PYTHON_DEPS} )
"
