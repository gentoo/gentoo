...
inherit cmake optfeature python-single-r1 verify-sig

DESCRIPTION="A fast and easy-to-use tool for creating status bars"
HOMEPAGE="https://github.com/polybar/polybar"
SRC_URI="https://github.com/polybar/${PN}/releases/download/${PV}/${P}.tar.gz
	verify-sig? ( https://github.com/polybar/polybar/releases/download/${PV}/${P}.tar.gz.asc )"
...
VERIFY_SIG_OPENPGP_KEY_PATH=/usr/share/openpgp-keys/patrick96.asc
