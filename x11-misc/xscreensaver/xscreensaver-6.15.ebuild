...
SRC_URI="
	...
	logind-idle-hint? (
		https://github.com/Flowdalic/xscreensaver/commit/5f76b84b06583d867cb05a443456eb975ae7496a.patch ->
			${PN}-6.15-logind-idle-hint.patch
	)
	systemd? (
...
src_prepare() {
	...
	if use logind-idle-hint; then
		eapply "${DISTDIR}/${PN}-6.15-logind-idle-hint.patch"
	fi
