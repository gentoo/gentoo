...
"
SRC_URI="https://github.com/${PN}-desktop-wiki/${PN}-desktop-wiki/archive/${PV}.tar.gz -> ${P}.tar.gz"
...
DEPEND="
	${RDEPEND}
"
DOCS=( {CHANGELOG,CONTRIBUTING,PLUGIN_WRITING,README}.md )
PATCHES=( "${FILESDIR}/${PN}-0.60-remove-ubuntu-theme.patch" )
S=${WORKDIR}/${PN}-desktop-wiki-${PV}
