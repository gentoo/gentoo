...
mrustc_bootstrap() {
	...
	# mrustc requires gcc, so disable libcxx
	...
	if use system-llvm; then
		...
		# g++ doesn't have libc++'s header path built-in
	...
	elog "Using LLVM_CONFIG: ${LLVM_CONFIG}"

	elog "Preparing wrapper of llvm-config"
