...
NUGETS="
boogie.abstractinterpretation@3.4.3
boogie.basetypes@3.4.3
boogie.codecontractsextender@3.4.3
boogie.concurrency@3.4.3
boogie.core@3.4.3
boogie.executionengine@3.4.3
boogie.graph@3.4.3
boogie.houdini@3.4.3
boogie.model@3.4.3
boogie.provers.leanauto@3.4.3
boogie.provers.smtlib@3.4.3
boogie.vcexpr@3.4.3
boogie.vcgeneration@3.4.3
castle.core@4.4.0
...
src_prepare() {
	...
	sed -i "${lit_config}" \
		-e "s|dotnet run |${DOTNET_PKG_EXECUTABLE} run ${lit_dotnet_run_opts[*]} |g" \
	...
	local -a bad_tests=(
		...
		exports
		git-issues
		gomodule/multimodule
		gomodule/publishedruntime
		gomodule/singlemodule
		lambdas
		metatests
		printing
		pythonmodule
...
src_compile () {
	...
	if use test ; then
		# This is where Dafny test suite expects to find compiled sources.
		rm -r ./Binaries || die
