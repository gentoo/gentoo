...
SRC_URI+=" mips? (
	abi_mips_o32? (
		big-endian?  ( https://github.com/matoro/rust/releases/download/${PV}/${MY_P}-mips-unknown-linux-gnu.tar.xz )
		!big-endian? ( https://github.com/matoro/rust/releases/download/${PV}/${MY_P}-mipsel-unknown-linux-gnu.tar.xz )
	)
	abi_mips_n64? (
		big-endian?  ( https://github.com/matoro/rust/releases/download/${PV}/${MY_P}-mips64-unknown-linux-gnuabi64.tar.xz )
		!big-endian? ( https://github.com/matoro/rust/releases/download/${PV}/${MY_P}-mips64el-unknown-linux-gnuabi64.tar.xz )
	)
)"
