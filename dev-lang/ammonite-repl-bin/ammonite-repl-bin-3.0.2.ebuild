...
SRC_URI="
	...
	scala3-3? ( https://github.com/com-lihaoyi/Ammonite/releases/download/${PV}/3.3-${PV} -> ${P}-3.3 )
	scala3-5? ( https://github.com/com-lihaoyi/Ammonite/releases/download/${PV}/3.5-${PV} -> ${P}-3.5 )
"
