...
SRC_URI="
	...
	https://github.com/JuliaLang/julia/commit/99d4e655.patch -> ${PN}-1.7.1-llvm_13_compat_part_6.patch
"
...
PATCHES=(
	...
	# bug https://bugs.archlinux.org/task/73247 - fix crashes on Atom editor
	"${DISTDIR}/${PN}"-1.7.1-llvm_13_compat_part_6.patch
	...
	"${FILESDIR}/${PN}"-1.7.1-Version.patch
