...
BOOTSTRAP_DIST="https://dev.gentoo.org/~xen0n/distfiles/dev-lang/go-bootstrap"
SRC_URI="
	...
	mips? (
		big-endian? (
			abi_mips_n64? ( ${BOOTSTRAP_DIST}/go-linux-mips64-bootstrap-${PV}.tbz )
			abi_mips_o32? ( ${BOOTSTRAP_DIST}/go-linux-mips-bootstrap-${PV}.tbz )
		)
		!big-endian? (
			abi_mips_n64? ( ${BOOTSTRAP_DIST}/go-linux-mips64le-bootstrap-${PV}.tbz )
			abi_mips_o32? ( ${BOOTSTRAP_DIST}/go-linux-mipsle-bootstrap-${PV}.tbz )
		)
	)
	ppc64? (
...
IUSE="big-endian abi_mips_n64 abi_mips_o32"
