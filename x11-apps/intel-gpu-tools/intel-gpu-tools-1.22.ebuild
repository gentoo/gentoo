...
SRC_URI="mirror://www.x.org/releases/individual/app/${P}.tar.xz"
KEYWORDS="~amd64 ~x86"
LICENSE="MIT"
SLOT="0"
IUSE="alsa glib gsl sound chamelium gtk-doc test-programs udev valgrind video_cards_amdgpu video_cards_intel video_cards_nouveau X xrandr xv"
