...
LICENSE="MIT"
SLOT="0"
IUSE="alsa glib gsl sound chamelium gtk-doc udev valgrind video_cards_amdgpu video_cards_intel video_cards_nouveau X xrandr xv"
...
src_configure() {
	epatch "${FILESDIR}"/${P}-KBL-ICL-PCI-IDs.patch
	meson_src_configure
}
