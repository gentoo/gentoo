...
DESCRIPTION="Selenium Manager is a CLI tool that automatically manages the browser/driver infrastructure required by Selenium."
...
src_prepare() {
	...
	rm -f tests/{cli,iexplorer,safari,stable_browser}_tests.rs || die
}
