...
inherit eutils multiprocessing toolchain-funcs git-r3

DESCRIPTION="Port of many Plan 9 programs and libraries"
HOMEPAGE="http://swtch.com/plan9port/"
EGIT_REPO_URI="https://github.com/9fans/plan9port"
...
src_prepare() {
	...
	eapply "${FILESDIR}/${PN}-"{noexecstack,cflags}".patch"
	eapply "${FILESDIR}/${P}-builderr.patch"
	case ${CHOST} in
		*freebsd10.*)  # patch 9l to use -pthread also on FreeBSD-10
			eapply "${FILESDIR}/${PN}-freebsd-10.patch" ;;
		*apple*)
