...
SRC_URI="https://github.com/nmeum/android-tools/releases/download/${MY_PV}/${PN}-${MY_PV}.tar.xz
	...
	https://github.com/mid-kid/android-tools/commit/f9b7a7080385018e79e83e3d146b48579a031753.patch -> ${PN}-disable-werror-boringssl.patch
"
S="${WORKDIR}/${PN}-${MY_PV}"
...
src_prepare() {
	...
	eapply "${DISTDIR}/${PN}-disable-werror-boringssl.patch"
