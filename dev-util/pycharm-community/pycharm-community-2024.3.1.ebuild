...
# SRC_URI assumes amd64+x86 and arm64
SRC_URI="
	arm64? ( https://download.jetbrains.com/python/${P}-aarch64.tar.gz )
	!arm64? ( https://download.jetbrains.com/python/${P}.tar.gz )
"
...
# Eclipse Distribution License is BSD-3-clause
# dbus-java is not "LGPL" but MIT
# TODO: research the "Unicode" license
LICENSE="
	Apache-2.0
	BSD BSD-2
	CC0-1.0 CC-BY-2.5 CDDL-1.1 codehaus-classworlds
	EPL-1.0
	GPL-2 GPL-2-with-classpath-exception
	JSON
	LGPL-2.1 LGPL-3
	MIT MPL-1.0
	OFL-1.1
