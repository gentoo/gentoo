...
inherit ${SCM} bash-completion-r1 distutils-r1
...
PATCHES=( "${FILESDIR}/do-not-install-completion.patch" )
DISTUTILS_IN_SOURCE_BUILD="yes"

python_install_all() {
	distutils-r1_python_install_all

	newbashcomp completion/wstool-completion.bash "${PN}"
	insinto /usr/share/zsh/site-functions
	doins completion/wstool-completion.bash
	doins completion/_wstool
}
