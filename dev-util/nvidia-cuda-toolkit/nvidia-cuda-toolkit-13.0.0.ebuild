...
src_install() {
	...
	# crt headers are in shared include location, but the compiler autoincludes
	# the target specific header location.
	dosym -r "${CUDA_PATH}/include/crt" "${CUDA_PATH}/targets/${narch}-linux/include/crt"
