...
if [[ -z ${PV%%*9999} ]]; then
	...
	KEYWORDS="~alpha ~amd64 ~arm ~arm64 ~hppa ~ppc64 ~s390 ~x86 ~ppc-aix ~x86-fbsd ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
fi
