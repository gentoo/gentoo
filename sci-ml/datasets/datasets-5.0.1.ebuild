...
RDEPEND="
	...
	')
	torch? (
		>=sci-ml/pytorch-2.13.0[${PYTHON_SINGLE_USEDEP},numpy]
	)
"
DEPEND="${RDEPEND}"
# Missing x test:
...
EPYTEST_PLUGINS=( pytest-datadir )
...
python_test() {
	local EPYTEST_IGNORE=(
		...
		tests/packaged_modules/test_iceberg.py
	)
	...
	local EPYTEST_DESELECT=(
		...
		tests/test_arrow_dataset.py::BaseDatasetTest::test_to_parquet_in_memory
		tests/test_arrow_dataset.py::BaseDatasetTest::test_to_parquet_on_disk
	)
