...
IUSE="+binary uefi uefi64 ipv6 iso lkrn +qemu undi usb vmware"
...
src_compile() {
	...
	use uefi && ipxemake PLATFORM=efi BIN=bin-i386-efi bin-i386-efi/ipxe.efi
...
src_install() {
	...
	use uefi && newins bin-i386-efi/ipxe.efi ipxe-i386.efi
	...
	use uefi && dosym ipxe-i386.efi /usr/share/ipxe/ipxe.efi
