...
SRC_URI="http://dell.archive.canonical.com/updates/pool/public/libf/libfprint-2-tod1-broadcom/libfprint-2-tod1-broadcom_${PV}-5.15.010.0.orig.tar.gz"
S="${WORKDIR}/brcm_linux_fp"
