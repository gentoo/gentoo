...
# UK manpages break compile currently
...
inherit autotools linux-info multilib-minimal optfeature plocale \
	python-single-r1 pam systemd tmpfiles toolchain-funcs
...
if [[ ${PV} != 9999 ]]; then
	SRC_URI="https://github.com/SSSD/sssd/releases/download/${MY_PV}/${MY_P}.tar.gz"
	if [[ ${PV} != *_beta* ]]; then
...
LICENSE="GPL-3"
SLOT="0"
IUSE="doc +netlink nfsv4 nls python samba selinux systemd systemtap test"
REQUIRED_USE="
