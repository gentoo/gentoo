...
PATCHES=(
	"${FILESDIR}"/${PN}-2026.03.16.00-Use-FOLLY_HAS_LIBURING-to-check-for-liburing-support.patch
	"${FILESDIR}"/${PN}-2026.03.16.00-Fix-BUILD_SHARED_LIBS-ON-remove-circular-dependency.patch
)
