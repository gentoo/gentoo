...
src_prepare() {
	...
	# fix for boost >= 1.89 (bug #963333)
	if has_version ">=dev-libs/boost-1.89.0"; then
		# remove boost_system dependency smeared all over the place
		eapply -p1 "${FILESDIR}/${PN}-3.0.9-boost-1.89.patch"
	fi
}
