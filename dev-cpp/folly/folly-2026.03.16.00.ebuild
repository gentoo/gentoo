...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-2026.03.16.00-cmake-add-blake3-integration.patch
	"${FILESDIR}"/${PN}-2026.03.16.00-cmake-add-missing-memset-assembly-implementation.patch
	"${FILESDIR}"/${PN}-2026.03.16.00-memory-add-custom-main-to-mallctlhelpertest.patch
)
...
src_test() {
	CMAKE_SKIP_TESTS=(
		...
		# Test aborts.
		# https://github.com/facebook/folly/issues/2603
