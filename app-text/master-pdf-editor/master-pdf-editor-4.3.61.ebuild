...
DESCRIPTION="Master PDF Editor is the complete solution for viewing and editing PDF files."
...
src_install() {
	...
	make_desktop_entry ${bin_name} "Master PDF Editor ${PV}" ${dest}/${bin_name}.png "Office;Graphics;Viewer" "MimeType=application/pdf;application/x-bzpdf;application/x-gzpdf;\nTerminal=false"
}
