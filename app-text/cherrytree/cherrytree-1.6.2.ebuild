...
IUSE="+deprecated +gtk3 gtk4 nls test"
...
RDEPEND="app-i18n/uchardet
	...
	gtk4? (
		...
		>=dev-cpp/glibmm-2.68.2:2.68
		>=dev-cpp/pangomm-2.49:2.48
		>=gui-libs/vte-0.70.2:2.91-gtk4
	)
...
src_configure() {
	local mycmakeargs=(
		-DPYTHON_EXEC="${PYTHON}"
		-DWITH_GTK4=$(usex gtk4)
		-DNO_DEPRECATED=$(usex deprecated no yes)
		-DUSE_NLS=$(usex nls)
