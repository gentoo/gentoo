...
src_test() {
	# the export tests don't work in the sandbox, though they pass when being
	# manually run from the working directory
	local myctestargs=( --exclude-regex "ExportsTests/ExportsMultipleParametersTests.ChecksExports" )
