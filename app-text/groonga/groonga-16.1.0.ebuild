...
src_configure() {
	local mycmakeargs=(
		...
		-DGRN_WITH_RAPIDJSON=no # deprecated
		...
		-DGRN_WITH_JSONCONS=$(usex json system no) # headers-only, no useflag for it
		-DGRN_WITH_SIMDJSON=$(usex json system no)
