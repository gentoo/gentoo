...
IUSE="cups djvu dvi gstreamer gnome gnome-keyring gtk-doc +introspection postscript spell tiff xps"
...
"
# nautilus? ( >=gnome-base/nautilus-3.28.0 ) # USE-flag nautilus removed because requires nautilus<42.2
RDEPEND="${DEPEND}
	gnome-base/gvfs
	gnome-base/librsvg
	|| (
