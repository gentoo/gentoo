...
IUSE="X +curl glut javascript lcms libressl +openssl static static-libs vanilla"
...
LIB_DEPEND="
	...
	glut? ( media-libs/freeglut[static-libs?] )"
RDEPEND="${LIB_DEPEND}"
DEPEND="${RDEPEND}
	virtual/pkgconfig
...
PATCHES=(
		...
		"${FILESDIR}"/${PN}-1.12-system-glut.patch
)
