...
LICENSE="MIT"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~arm ~arm64 ~hppa ~ppc ~s390 ~sparc ~x86 ~amd64-linux ~x86-linux"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-1.6.1-libxml2-2.14.0-compile.patch
	"${FILESDIR}"/${PN}-1.6.1-libxml2-2.13-stdin.patch
)
