...
RDEPEND="
	...
	llvm-core/clang-linker[default-lld(-)?]
	llvm-core/clang-rtlib[compiler-rt(-)?,default-compiler-rt(-)?]
	llvm-core/clang-unwindlib[default-compiler-rt(-)?,llvm-libunwind(-)?]
	llvm-core/clang-stdlib[default-libcxx(-)?,libcxx(-)?]
