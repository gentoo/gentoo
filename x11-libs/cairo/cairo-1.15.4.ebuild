...
SLOT="0"
IUSE="aqua debug directfb gles2 +glib opengl static-libs +svg valgrind win32 xcb xlib-xcb X"
...
src_prepare() {
	...
	if [[ ${PV} == *9999* ]]; then
		touch boilerplate/Makefile.am.features || die
		touch src/Makefile.am.features || die
		touch ChangeLog || die
	fi
...
multilib_src_configure() {
	...
	econf \
		...
		$(use_enable directfb) \
		$(usex elibc_FreeBSD --disable-symbol-lookup "")\
