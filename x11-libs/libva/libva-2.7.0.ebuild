...
VIDEO_CARDS="nvidia intel i965 nouveau iris"
...
PDEPEND="video_cards_nvidia? ( >=x11-libs/libva-vdpau-driver-0.7.4-r1[${MULTILIB_USEDEP}] )
	...
	video_cards_intel? ( >=x11-libs/libva-intel-driver-2.3.0[${MULTILIB_USEDEP}] )
	video_cards_i965? ( >=x11-libs/libva-intel-driver-2.3.0[${MULTILIB_USEDEP}] )
