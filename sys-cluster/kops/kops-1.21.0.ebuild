...
EGO_SUM=(
	...
	"github.com/Azure/azure-sdk-for-go v53.4.0+incompatible/go.mod"
	...
	"github.com/Masterminds/sprig/v3 v3.2.0/go.mod"
	...
	"github.com/MichaelTJones/walk v0.0.0-20161122175330-4748e29d5718/go.mod"
	...
	"github.com/Venafi/vcert/v4 v4.13.1/go.mod"
	...
	"github.com/aliyun/alibaba-cloud-sdk-go v1.61.1059/go.mod"
	...
	"github.com/aws/amazon-ec2-instance-selector/v2 v2.0.2/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.38.29/go.mod"
	...
	"github.com/denverdino/aliyungo v0.0.0-20210425065611-55bee4942cba/go.mod"
	...
	"github.com/digitalocean/godo v1.60.0/go.mod"
	...
	"github.com/googleapis/gnostic v0.5.4/go.mod"
	...
	"github.com/gophercloud/gophercloud v0.15.1-0.20210105012856-e34a44dc6580/go.mod"
	"github.com/gophercloud/gophercloud v0.18.0"
	"github.com/gophercloud/gophercloud v0.18.0/go.mod"
	...
	"github.com/hashicorp/vault/api v1.1.0/go.mod"
	...
	"github.com/jetstack/cert-manager v1.3.1/go.mod"
	...
	"github.com/pavel-v-chernykh/keystore-go/v4 v4.1.0/go.mod"
	...
	"github.com/spotinst/spotinst-sdk-go v1.85.0/go.mod"
	...
	"github.com/weaveworks/mesh v0.0.0-20191105120815-58dbcc3e8e63/go.mod"
	...
	"github.com/zclconf/go-cty v1.8.2/go.mod"
	...
	"gopkg.in/godo.v2 v2.0.9/go.mod"
	...
	"k8s.io/api v0.21.0"
	"k8s.io/api v0.21.0/go.mod"
	"k8s.io/apiextensions-apiserver v0.21.0"
	"k8s.io/apiextensions-apiserver v0.21.0/go.mod"
	"k8s.io/apimachinery v0.21.0"
	"k8s.io/apimachinery v0.21.0/go.mod"
	"k8s.io/apiserver v0.21.0/go.mod"
	"k8s.io/cli-runtime v0.21.0"
	"k8s.io/cli-runtime v0.21.0/go.mod"
	"k8s.io/client-go v0.21.0"
	"k8s.io/client-go v0.21.0/go.mod"
	"k8s.io/cloud-provider v0.21.0"
	"k8s.io/cloud-provider v0.21.0/go.mod"
	"k8s.io/cloud-provider-openstack v1.21.0"
	"k8s.io/cloud-provider-openstack v1.21.0/go.mod"
	"k8s.io/cluster-bootstrap v0.21.0/go.mod"
	"k8s.io/code-generator v0.21.0/go.mod"
	"k8s.io/component-base v0.21.0"
	"k8s.io/component-base v0.21.0/go.mod"
	"k8s.io/component-helpers v0.21.0/go.mod"
	"k8s.io/controller-manager v0.21.0/go.mod"
	"k8s.io/cri-api v0.21.0/go.mod"
	"k8s.io/csi-translation-lib v0.21.0"
	"k8s.io/csi-translation-lib v0.21.0/go.mod"
	"k8s.io/gengo v0.0.0-20200413195148-3a45101e95ac/go.mod"
	"k8s.io/gengo v0.0.0-20201214224949-b6c5ce23f027/go.mod"
	"k8s.io/gengo v0.0.0-20210203185629-de9496dff47b"
	"k8s.io/gengo v0.0.0-20210203185629-de9496dff47b/go.mod"
	...
	"k8s.io/kube-aggregator v0.21.0/go.mod"
	"k8s.io/kube-controller-manager v0.21.0/go.mod"
	...
	"k8s.io/kube-proxy v0.21.0/go.mod"
	"k8s.io/kube-scheduler v0.21.0/go.mod"
	"k8s.io/kubectl v0.21.0"
	"k8s.io/kubectl v0.21.0/go.mod"
	"k8s.io/kubelet v0.21.0/go.mod"
	"k8s.io/kubernetes v1.21.0/go.mod"
	"k8s.io/legacy-cloud-providers v0.21.0"
	"k8s.io/legacy-cloud-providers v0.21.0/go.mod"
	"k8s.io/metrics v0.21.0/go.mod"
	"k8s.io/mount-utils v0.21.0"
	"k8s.io/mount-utils v0.21.0/go.mod"
	"k8s.io/sample-apiserver v0.21.0/go.mod"
	...
	"sigs.k8s.io/controller-runtime v0.9.0-beta.0/go.mod"
