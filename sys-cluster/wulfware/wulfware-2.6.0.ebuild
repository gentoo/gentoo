...
src_install() {
	...
	gunzip "${ED}"/usr/share/man/man1/{wulf2html,wulflogger,wulfstat}.1.gz || die
	gunzip "${ED}"/usr/share/man/man3/libwulf.3.gz || die
	gunzip "${ED}"/usr/share/man/man8/xmlsysd.8.gz || die
}
