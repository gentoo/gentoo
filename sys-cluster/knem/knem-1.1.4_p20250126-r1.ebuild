...
PATCHES=(
	"${FILESDIR}/${PN}-1.1.4_p20250126-linux-api-cleanup.patch"
	"${FILESDIR}/${PN}-1.1.4_p20250126-linux-gt-6.16-fix.patch"
	"${FILESDIR}/${PN}-1.1.4_p20250126-linux-gt-6.15-fix.patch"
	)
