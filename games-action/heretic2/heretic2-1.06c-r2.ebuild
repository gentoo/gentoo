...
SRC_URI="https://updates.lokigames.com/${PN}/${P/%?/b}-unified-x86.run
	https://updates.lokigames.com/${PN}/${P}-unified-x86.run
	https://updates.lokigames.com/${PN}/${PN}-maps-1.0.run"
S="${WORKDIR}"
