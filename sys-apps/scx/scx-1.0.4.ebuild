...
SRC_URI="
	https://github.com/sched-ext/scx/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}
"
...
PATCHES=(
	"${FILESDIR}/scx-1.0.4-cargo-target.patch"
)
...
src_install() {
	local -x SCX_CARGO_TARGET_DIR="$(rust_abi)/$(usex debug debug release)"
