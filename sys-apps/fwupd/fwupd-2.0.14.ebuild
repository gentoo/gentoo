...
IUSE="video_cards_amdgpu +archive +readline bash-completion bluetooth cbor flashrom gnutls gtk-doc introspection protobuf lzma minimal modemmanager policykit spi +readline sqlite systemd test tpm uefi"
...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	systemd? ( >=sys-apps/systemd-249[seccomp] )
...
DEPEND="
	${COMMON_DEPEND}
	>=x11-libs/pango-1.56.2[introspection]
