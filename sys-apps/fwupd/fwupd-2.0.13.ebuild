...
IUSE="amdgpu +archive bash-completion bluetooth cbor flashrom gnutls gtk-doc introspection protobuf lzma minimal modemmanager policykit spi systemd test tpm uefi"
