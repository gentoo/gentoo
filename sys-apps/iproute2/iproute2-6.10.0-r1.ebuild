...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-6.10.0-fix-implecit-declaration-of-basename-on-musl.patch # bug #926341
	"${FILESDIR}"/${PN}-6.10.0-fix-implicit-declaration-of-htobe64.patch # bug #936234
)
