...
PLOCALES="ar as bg ca cs de el en_CA en_GB eo es et eu fi fr gl gu he hi hu id
 it ja kn ko lt lv ml mr nb nl or pa pl pt_BR pt ro ru sl sr@latin sr sv ta te
 tr uk vi zh_CN"

inherit check-reqs cmake-utils eutils flag-o-matic gnome2 l10n pax-utils python-any-r1 ruby-single toolchain-funcs versionator virtualx
