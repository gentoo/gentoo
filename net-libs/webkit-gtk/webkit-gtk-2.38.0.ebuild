...
src_configure() {
	...
	local mycmakeargs=(
		...
		# Disabling PDF.js in webkit-gtk-2.38.x as the eventually-solution to treating PDF files like any other download in epiphany,
		# please refer bug 872581 and https://gitlab.gnome.org/GNOME/epiphany/-/issues/1750
