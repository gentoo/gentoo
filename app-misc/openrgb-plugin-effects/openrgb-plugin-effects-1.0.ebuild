...
MY_PV=$(ver_rs 2 "")
SRC_URI="
	https://codeberg.org/OpenRGB/OpenRGBEffectsPlugin/archive/release_${PV}.tar.gz -> ${P}.tar.gz
...
"
S="${WORKDIR}/openrgbeffectsplugin"
...
PATCHES=(
	"${FILESDIR}/openrgb-plugin-effects-1.0-dep.patch"
