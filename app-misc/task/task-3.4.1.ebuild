...
inherit cargo bash-completion-r1 shell-completion cmake
...
# Upstream does not provide test suite in tar balls/releases
# https://github.com/GothenburgBitFactory/taskwarrior/issues/2368
# src_test() {
# }
...
src_install() {
	...
	# fish-completions
	dofishcomp /usr/share/fish/vendor_completions.d
	doins scripts/fish/*
