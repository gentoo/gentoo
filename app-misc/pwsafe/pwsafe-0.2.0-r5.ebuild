...
PATCHES=(
	"${FILESDIR}/${P}-cvs-1.57-p1.patch"
	"${FILESDIR}/${P}-printf-p1.patch"
	"${FILESDIR}/${P}-fake-readline-p1.patch"
	"${FILESDIR}/${P}-man-page-option-syntax-p1.patch"
	"${FILESDIR}/${P}-XChangeProperty-p1.patch"
)
