...
LICENSE="GPL-2"
SLOT="0"
IUSE="doc appindicator libnotify test dbus wayland"
RESTRICT="!test? ( test )"

BDEPEND="test? ( dev-python/pytest-mock )"
...
EPYTEST_DESELECT=(
	# tests depend on desktop stuff being available, but we are in sandbox
