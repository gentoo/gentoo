...
src_prepare() {
	...
	# wpa3 support on broadcom hardware
	eapply "${FILESDIR}/${PN}-2.10-nl80211-check-sae-authentication-offload-support.patch"
	eapply "${FILESDIR}/${PN}-2.10-sae-pass-sae-password-on-connect-for-sae-authentication-offload-support.patch"
