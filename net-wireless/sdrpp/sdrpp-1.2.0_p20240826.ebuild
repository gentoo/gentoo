...
SLOT=0
KEYWORDS="~amd64 ~x86"
IUSE="+airspy atv +audio-sink +audio-src badgesdr +bladerf +hackrf +hermes +limesdr +m17 pager +plutosdr portaudio-sink +portaudio-new-sink +rtlsdr ryfi +sched +sdrplay soapysdr uhd"
PATCHES=(
