...
COMMIT_HASH="524cd2e548b11084e6f739b2dfe0f958c2e30354"
SRC_URI="https://github.com/myriadrf/LimeSuite/archive/${COMMIT_HASH}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/LimeSuite-${COMMIT_HASH}"
