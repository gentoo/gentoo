...
SRC_URI="http://releases.llvm.org/${PV/_//}/cfe-${PV/_/}.src.tar.xz
	...
	flang? ( https://dev.gentoo.org/~junghans/distfiles/${P}-flang.patch.xz )
...
IUSE="debug default-compiler-rt default-libcxx +doc flang multitarget
...
src_prepare() {
	...
	#apply NVidia's flang patch to support fortran
	use !flang || eapply "${S}"/../"${P}"-flang.patch
