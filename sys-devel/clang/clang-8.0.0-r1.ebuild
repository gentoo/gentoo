...
PATCHES=(
	...
	"${FILESDIR}"/8.0.0/0001-OpenCL-Change-type-of-block-pointer-for-OpenCL.patch
	"${FILESDIR}"/8.0.0/0002-OpenCL-Simplify-LLVM-IR-generated-for-OpenCL-blocks.patch
	"${FILESDIR}"/8.0.0/0003-OpenCL-Fix-assertion-due-to-blocks.patch
)
