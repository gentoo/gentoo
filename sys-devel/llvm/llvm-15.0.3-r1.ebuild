			...
			if [[ ${l} == install-*-stripped:* ]]; then
				...
				case ${l} in
					...
					LLVMDemangle|LLVMSupport|LLVMTableGen)
						;;
					#LLVMPasses(for flang) + deps
					LLVMPasses|LLVMAggressiveInstCombine|LLVMAnalysis|LLVMCore|LLVMCoroutines|LLVMipo|LLVMInstCombine|LLVMObjCARCOpts|LLVMScalarOpts|LLVMTarget|LLVMTransformUtils|LLVMVectorize|LLVMInstrumentation|LLVMBinaryFormat|LLVMRemarks|LLVMMC|LLVMProfileData|LLVMBitReader|LLVMBitWriter|LLVMFrontendOpenMP|LLVMIRReader|LLVMLinker|LLVMObject|LLVMProfileData|LLVMAsmParser|LLVMBitstreamReader|LLVMDebugInfoCodeView|LLVMMCParser|LLVMTextAPI|LLVMSymbolize|LLVMDebugInfoDWARF|LLVMDebugInfoPDB|LLVMDebugInfoMSF)
						use flang || continue
						;;
					# static libs
					LLVM*)
