...
inherit check-reqs chromium-2 desktop flag-o-matic ninja-utils pax-utils python-any-r1 readme.gentoo-r1 toolchain-funcs virtualx xdg-utils
...
SRC_URI="https://commondatastorage.googleapis.com/chromium-browser-official/${P}.tar.xz
	...
	pgo? ( http://blackhole.sk/~kabel/src/chromium-profiler-0.2.tar )"
...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-96-sql-make-VirtualCursor-stan.patch"
