...
LICENSE="BSD Apache-2.0 APSL-2 BSD-2 GPL-2 GPL-2+ GPL-3+ icu ISC LGPL-2 LGPL-2+ LGPL-2.1 LGPL-2.1+ MIT MPL-1.1 MPL-2.0 Ms-PL public-domain"
SLOT="0/stable"
...
src_prepare() {
	...
	local PATCHES=(
		...
		"${FILESDIR}/chromium-disable-unrar.patch"
	)
