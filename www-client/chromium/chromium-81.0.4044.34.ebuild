...
inherit check-reqs chromium-2 desktop flag-o-matic multilib ninja-utils pax-utils portability python-any-r2 readme.gentoo-r1 toolchain-funcs xdg-utils
