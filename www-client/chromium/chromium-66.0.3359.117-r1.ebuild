...
IUSE="component-build cups extra-fonts gnome-keyring +hangouts jumbo-build kerberos neon pic +proprietary-codecs pulseaudio selinux +suid +system-ffmpeg +system-icu +system-libvpx +tcmalloc widevine"
...
Alternatively, set extra-fonts USE flag to automatically pull in
all of them.
"
}
