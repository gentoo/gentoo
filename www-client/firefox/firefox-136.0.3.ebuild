...
src_test() {
	...
	#FIXME: Doesn't play well with GCC lto, PGO and requires apparent patching for USE="-pulseaudio"
	...
	# Note: gtest builds an alternate libxul with tests built-in and the tests are run against that
