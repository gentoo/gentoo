...
SRC_URI="https://github.com/tats/w3m/archive/${MY_COMMIT}.tar.gz -> ${P}.tar.gz"
...
src_prepare() {
	...
	sed -i "/^AR=/s:ar:$(tc-getAR):" {.,w3mimg,libwc}/Makefile.in || die
...
src_configure() {
	...
	myconf+=( --enable-keymap=$(usex lynxkeymap lynx w3m) )
