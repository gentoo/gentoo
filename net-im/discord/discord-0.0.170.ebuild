...
SRC_URI="https://dl-canary.discordapp.net/apps/linux/${MY_PV}/${MY_PN}-canary-${MY_PV}.tar.gz -> ${PN}-${PV}.tar.gz"
# https://dl-canary.discordapp.net/apps/linux/0.0.170/discord-canary-0.0.170.tar.gz
