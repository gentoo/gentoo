...
src_install() {
	...
	if use suid; then
		...
		ewarn "You have set USE=suid meaning that you intend to run"
		ewarn "${PN} sandbox with root privileges. This is NOT receomended"
		ewarn "recent kernels should enable namespace support for a better"
		ewarn "sandbox support."
	fi
