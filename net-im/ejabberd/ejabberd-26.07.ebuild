...
DEPEND="
	...
	mysql? ( >=dev-erlang/p1_mysql-1.0.28 )
	odbc? ( dev-db/unixODBC )
	pam? ( >=dev-erlang/epam-1.0.14 )
	postgres? ( >=dev-erlang/p1_pgsql-1.1.41 )
	redis? ( >=dev-erlang/eredis-1.7.1 )
	sip? ( >=dev-erlang/esip-1.0.60 )
	sqlite? ( >=dev-erlang/sqlite3-1.1.15 )
	stun? ( >=dev-erlang/stun-1.2.22 )
	zlib? ( >=dev-erlang/ezlib-1.0.16 )
"
RDEPEND="
	${DEPEND}
