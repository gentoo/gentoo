...
IUSE="+seccomp swiftshader system-ffmpeg"
...
src_prepare() {
	...
	if ! use swiftshader; then
		rm -r libvk_swiftshader.so swiftshader || die
		elog "Running without SwiftShader OpenGL implementation. If Discord doesn't start "
