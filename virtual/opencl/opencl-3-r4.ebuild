...
pkg_postinst() {
	...
	elog
	elog " * open:"
	elog "    - dev-libs/intel-compute-runtime - integrated Intel GPUs from Gen5 up to Gen11. 64-bit only;"
	elog "    - dev-libs/intel-compute-runtime-legacy - integrated Intel GPUs from Gen12 onwards. 64-bit only;"
