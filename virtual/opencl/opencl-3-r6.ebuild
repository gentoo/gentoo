...
pkg_postinst() {
	...
	# 64bit only
	use amd64 && {
		optfeature "integrated Intel GPUs, generations >=12" dev-libs/intel-compute-runtime
		optfeature "integrated Intel GPUs, generations 8-11" dev-libs/intel-compute-runtime:legacy
