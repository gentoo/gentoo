...
IUSE="bash-completion gtk-doc selinux test"
...
BDEPEND="
	...
	bash-completion? (
		...
		$(python_gen_cond_dep 'dev-python/shtab[${PYTHON_USEDEP}]')
	)
	gtk-doc? (
		dev-util/gi-docgen
		dev-util/gtk-doc
...
python_check_deps() {
	...
	if use bash-completion; then
		python_has_version "dev-python/shtab[${PYTHON_USEDEP}]"
	fi
	python_has_version "dev-python/argparse-manpage[${PYTHON_USEDEP}]"
