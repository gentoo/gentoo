...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	>=dev-libs/libreport-2.9.5[${PYTHON_USEDEP}]
	dev-libs/libxml2
	dev-libs/nss
	sys-apps/dbus
	sys-auth/polkit
...
src_install() {
	...
	newinitd "${FILESDIR}/${PN}-2.0.12-r1-init" abrt # probably needs updated
	newconfd "${FILESDIR}/${PN}-2.0.12-r1-conf" abrt # probably needs updated
}
