...
src_install() {
	...
	rm "${D}"/opt/puppetlabs/pdk/private/ruby/2.4.5/lib/ruby/gems/2.4.0/gems/ffi-1.9.25/ext/ffi_c/libffi-x86_64-linux/a.out
	rm "${D}"/opt/puppetlabs/pdk/share/cache/ruby/2.1.0/gems/ffi-1.10.0/ext/ffi_c/libffi-x86_64-linux/a.out
	rm "${D}"/opt/puppetlabs/pdk/share/cache/ruby/2.4.0/gems/ffi-1.10.0/ext/ffi_c/libffi-x86_64-linux/a.out
	rm "${D}"/opt/puppetlabs/pdk/share/cache/ruby/2.5.0/gems/ffi-1.10.0/ext/ffi_c/libffi-x86_64-linux/a.out
