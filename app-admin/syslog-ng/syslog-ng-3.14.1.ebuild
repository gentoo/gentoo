...
# please test with locales C and utf8
PYTHON_COMPAT=( python2_7 python3_5 )

inherit autotools python-single-r1 eutils multilib systemd user versionator
...
pkg_postinst() {
	...
	elog "https://syslog-ng.com/documents/html/syslog-ng-ose-3.14-guides/en/syslog-ng-ose-guide-admin/html/index.html"

	if use caps; then
		enewuser syslog-ng

		ewarn "You should let syslog-ng run as user (and group) syslog-ng instead of root."
		ewarn "For more details take a look into your daemon configuration file."
		echo
	fi
