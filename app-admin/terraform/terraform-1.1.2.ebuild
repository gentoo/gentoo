...
EGO_SUM=(
	...
	"github.com/Azure/azure-sdk-for-go v59.2.0+incompatible/go.mod"
	...
	"github.com/Azure/go-autorest/autorest/azure/cli v0.4.4/go.mod"
	...
	"github.com/Netflix/go-expect v0.0.0-20211003183012-e1a7c020ce25/go.mod"
	...
	"github.com/andybalholm/crlf v0.0.0-20171020200849-670099aa064f/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.40.25/go.mod"
	...
	"github.com/hashicorp/go-azure-helpers v0.18.0/go.mod"
	...
	"github.com/hashicorp/go-tfe v0.19.1-0.20211020175229-e52963e079d0/go.mod"
	...
	"github.com/hashicorp/terraform-exec v0.14.0/go.mod"
	"github.com/hashicorp/terraform-json v0.12.0/go.mod"
	"github.com/hashicorp/terraform-plugin-go v0.4.0/go.mod"
	"github.com/hashicorp/terraform-plugin-sdk/v2 v2.8.0/go.mod"
	...
	"github.com/manicminer/hamilton v0.35.0/go.mod"
	...
	"github.com/mitchellh/go-testing-interface v1.0.4/go.mod"
	...
	"github.com/mozillazg/go-httpheader v0.3.0/go.mod"
	...
	"github.com/sebdah/goldie v1.0.0/go.mod"
	...
	"github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.194/go.mod"
	"github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.232"
	"github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.232/go.mod"
	...
	"go.etcd.io/etcd v0.5.0-alpha.5.0.20210428180535-15715dcf1ace/go.mod"
	...
	"honnef.co/go/tools v0.3.0-0.dev/go.mod"
	"k8s.io/api v0.21.3"
	"k8s.io/api v0.21.3/go.mod"
	"k8s.io/apimachinery v0.21.3"
	"k8s.io/apimachinery v0.21.3/go.mod"
	"k8s.io/client-go v0.21.3"
	"k8s.io/client-go v0.21.3/go.mod"
