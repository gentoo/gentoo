...
EGO_SUM=(
	...
	"github.com/Azure/go-autorest v12.2.0+incompatible/go.mod"
	...
	"github.com/Azure/go-autorest/autorest v0.9.4/go.mod"
	...
	"github.com/antlr/antlr4 v0.0.0-20200326173327-a4c66dc863bb/go.mod"
	...
	"github.com/bradleyfalzon/ghinstallation v1.1.0/go.mod"
	...
	"github.com/coreos/bbolt v1.3.1-coreos.6.0.20180318001526-af9db2027c98/go.mod"
	...
	"github.com/elastic/ecs v1.5.0/go.mod"
	...
	"github.com/elastic/go-structform v0.0.6/go.mod"
	"github.com/elastic/go-sysinfo v1.1.1/go.mod"
	"github.com/elastic/go-sysinfo v1.3.0"
	"github.com/elastic/go-sysinfo v1.3.0/go.mod"
	...
	"github.com/elastic/gosigar v0.10.5/go.mod"
	"github.com/elastic/sarama v1.19.1-0.20200629123429-0e7b69039eec"
	"github.com/elastic/sarama v1.19.1-0.20200629123429-0e7b69039eec/go.mod"
	...
	"github.com/garyburd/redigo v1.0.1-0.20160525165706-b8dc90050f24/go.mod"
	...
	"github.com/google/go-github/v29 v29.0.2/go.mod"
	...
	"github.com/googleapis/gnostic v0.3.1-0.20190624222214-25d8b0b66985/go.mod"
	...
	"github.com/h2non/filetype v1.0.12/go.mod"
	...
	"github.com/haya14busa/go-actions-toolkit v0.0.0-20200105081403-ca0307860f01/go.mod"
	"github.com/haya14busa/go-checkstyle v0.0.0-20170303121022-5e9d09f51fa1/go.mod"
	"github.com/haya14busa/secretbox v0.0.0-20180525171038-07c7ecf409f5/go.mod"
	...
	"github.com/josephspurrier/goversioninfo v0.0.0-20200309025242-14b0ab84c6ca/go.mod"
	...
	"github.com/justinas/nosurf v1.1.0/go.mod"
	...
	"github.com/mattn/go-colorable v0.0.8/go.mod"
	...
	"github.com/mattn/go-shellwords v1.0.7/go.mod"
	...
	"github.com/pierrre/gotestcover v0.0.0-20160113212533-7b94f124d338/go.mod"
	...
	"github.com/rakyll/statik v0.1.6/go.mod"
	...
	"github.com/reviewdog/errorformat v0.0.0-20200109134752-8983be9bc7dd/go.mod"
	"github.com/reviewdog/reviewdog v0.9.17"
	"github.com/reviewdog/reviewdog v0.9.17/go.mod"
	...
	"github.com/shirou/gopsutil v2.19.11+incompatible/go.mod"
	...
	"github.com/tsg/gopacket v0.0.0-20190320122513-dd3d0e41124a/go.mod"
	"github.com/urfave/cli v0.0.0-20171014202726-7bc6a0acffa5/go.mod"
	"github.com/urso/diag v0.0.0-20200125202105-ffdc32ff5518/go.mod"
	...
	"github.com/urso/diag-ecs v0.0.0-20200210114345-ab085841dcb9/go.mod"
	"github.com/urso/ecslog v0.0.1"
	"github.com/urso/ecslog v0.0.1/go.mod"
	...
	"github.com/urso/magetools v0.0.0-20200125210132-c2e338f92f3a"
	"github.com/urso/magetools v0.0.0-20200125210132-c2e338f92f3a/go.mod"
	...
	"github.com/xanzy/go-gitlab v0.22.3/go.mod"
	...
	"go.elastic.co/ecszap v0.1.1-0.20200424093508-cdd95a104193/go.mod"
	...
	"k8s.io/api v0.0.0-20190722141453-b90922c02518/go.mod"
	"k8s.io/apimachinery v0.0.0-20190612205821-1799e75a0719/go.mod"
	"k8s.io/apimachinery v0.0.0-20190719140911-bfcf53abc9f8"
	"k8s.io/apimachinery v0.0.0-20190719140911-bfcf53abc9f8/go.mod"
	...
	"k8s.io/klog v0.3.4-0.20190719014911-6a023d6d0e09/go.mod"
	...
	"sigs.k8s.io/yaml v1.1.1-0.20190704183835-4cd0c284b15f/go.mod"
)
