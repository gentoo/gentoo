...
if [[ ${PV} == 9999* ]] ; then
	...
	SRC_URI="https://github.com/vim/vim/archive/v${PV}.tar.gz -> vim-${PV}.tar.gz
		https://github.com/douglarek/gentoo-vim-patches/releases/download/vim-${VIM_PATCHES_VERSION}-patches/vim-patches-vim-${VIM_PATCHES_VERSION}-patches.tar.bz2"
