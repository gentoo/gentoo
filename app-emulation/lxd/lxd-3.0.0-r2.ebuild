...
# We have the rename the distfile because the 3.0.0-r2 distfile doesn't have
# the same content as the 3.0.0 distfile. The former has a "dist" folder and not
# the latter. This rename can disappear in the next upstream bump.
SRC_URI="https://linuxcontainers.org/downloads/${PN}/${P}.tar.gz -> ${P}-r2.tar.gz"
