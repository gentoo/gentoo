...
pkg_postinst() {
	elog "In order to use PCem, you will need some roms for various systems."
	elog "You can either install globally for all users or local for youself."
	elog ""
	elog "To install globally, put your ROM file in /usr/share/pcem/roms/<system>."
	elog "To install local, put your ROM file in /home/<user>/.pcem/roms/<system>."
}
