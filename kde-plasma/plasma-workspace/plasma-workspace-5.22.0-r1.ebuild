...
PATCHES=(
	# fixed in 5.22.1, see https://bugs.kde.org/show_bug.cgi?id=437364
	"${FILESDIR}/${PN}-5.22.0-fix-krunnerglobalshortcuts.patch"
	# downstream patch
	"${FILESDIR}/${PN}-5.21.5-split-libkworkspace.patch"
	)
