...
src_configure() {
	...
	# FIXME: Temporary fix for spidermonkey 1.40.1 or 1.40.2:
	# https://discourse.gnome.org/t/gnome-49-to-depend-on-spidermonkey-140
	append-cppflags -DXP_UNIX
