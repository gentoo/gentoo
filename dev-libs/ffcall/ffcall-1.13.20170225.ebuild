...
SRC_URI="https://haible.de/bruno/gnu/libffcall-${MY_PV}.tar.gz"
...
SLOT="0"
KEYWORDS="~alpha ~amd64 ~hppa ~ia64 ~ppc ~ppc64 ~sparc ~x86 ~x86-fbsd ~amd64-linux ~x86-linux ~ppc-macos ~x86-macos ~x64-macos ~sparc-solaris ~x86-solaris"

S="${WORKDIR}/libffcall-${MY_PV}"

src_prepare() {
	eapply_user
	eapply "${FILESDIR}"/${PN}-make-jN.patch
