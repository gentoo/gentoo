...
SRC_URI="
	https://github.com/OpenSC/OpenSC/releases/download/${PV}/${P}.tar.gz
	https://src.fedoraproject.org/rpms/${PN}/raw/663c939ecd4b825be0513823306aba0199c63449/f/${P}-cardos.patch
"
