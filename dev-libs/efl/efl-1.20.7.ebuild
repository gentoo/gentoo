...
inherit enlightenment pax-utils gnome2-utils xdg-utils

DESCRIPTION="Enlightenment Foundation Libraries all-in-one package"

LICENSE="BSD-2 GPL-2 LGPL-2.1 ZLIB"
IUSE="avahi +bmp debug connman drm +eet egl examples fbcon +fontconfig
	fribidi gif gles glib gnutls gstreamer harfbuzz hyphen +ico ibus
	jpeg2k libressl neon +luajit opengl ssl pdf physics pixman +png
	postscript +ppm +psd pulseaudio raw scim sdl sound svg systemd
	tga tiff tslib unwind v4l valgrind vlc vnc wayland webp X xcf
	xim xine xpm"
...
"
# TODO: external lz4 support currently broken because of unstable ABI/API
#	app-arch/lz4
