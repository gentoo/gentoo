...
# maintainer recommends to "live at head" so we can ship snapshots
# COMMIT="155c6b9e76e462e1d47ea528ca87f366adccdea3" # 2024.09.13

if [[ -n $COMMIT ]]; then
	SRC_URI="https://github.com/HowardHinnant/date/archive/${COMMIT}.tar.gz -> ${P}.gh.tar.gz"
	S="${WORKDIR}/${PN}-${COMMIT}"
else
	SRC_URI="https://github.com/HowardHinnant/date/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz"
fi
