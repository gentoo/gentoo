...
PHP_DEPEND="
	...
	php_targets_php8-4? ( dev-lang/php:8.4[curl,iconv,pcntl,posix,sockets] )
	php_targets_php8-5? ( dev-lang/php:8.5[curl,iconv,pcntl,posix,sockets] )
"
DEPEND="
...
pkg_postinst() {
	if ver_replacing -lt "1.11.9"; then
