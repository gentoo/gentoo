...
RDEPEND="
    ...
    $(python_gen_cond_dep '
        ...
        >=dev-python/django-cacheops-5.0.1[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-cors-headers-3.4.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-debug-toolbar-2.2[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-filter-2.3.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-mptt-0.11.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-pglocks-1.0.4[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-prometheus-2.0.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-rq-2.3.2[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-tables2-2.3.1[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-taggit-1.3.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/django-timezone-field-4.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/djangorestframework-3.11.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/drf-yasg-1.17.1[${PYTHON_MULTI_USEDEP},validation]
        >=dev-python/jinja-2.11.2[${PYTHON_MULTI_USEDEP}]
        >=dev-python/markdown-3.2.2[${PYTHON_MULTI_USEDEP}]
        >=dev-python/netaddr-0.8.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/pillow-7.2.0[${PYTHON_MULTI_USEDEP}]
        >=dev-python/psycopg-2.8.5[${PYTHON_MULTI_USEDEP}]
        >=dev-python/pycryptodome-3.9.8[${PYTHON_MULTI_USEDEP}]
        ...
        >=www-servers/gunicorn-20.0.4[${PYTHON_MULTI_USEDEP}]
        ldap? ( >=dev-python/django-auth-ldap-2.1[${PYTHON_MULTI_USEDEP}] )
    ')"
DEPEND="${RDEPEND}"

PATCHES=(
    "${FILESDIR}"/${PN}-${PV}-no-pip.patch
    )
