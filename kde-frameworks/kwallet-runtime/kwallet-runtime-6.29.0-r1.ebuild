...
PATCHSET="${KDE_ORG_NAME}-${PV}-patchset-1"
QTMIN=6.10.1
...
DEPEND="
	...
	>=kde-frameworks/kwallet-${PV}-r1:6
	=kde-frameworks/kwallet-${PV}*:6
...
PATCHES=(
	"${FILESDIR}/${P}-stdalone.patch" # downstream
	"${WORKDIR}/${PATCHSET}" # in 6.30/6.31
)
