...
FIREFOX_PATCHSET="firefox-154-patches-01t.tar.xz"
...
# Thunderbird-only RDEPEND, ESR and Stable.
if [[ -n ${MOZ_ESR} ]] ; then
	RDEPEND+=" ~mail-client/thunderbird-l10n-${PV}:0/esr"
else
	RDEPEND+=" ~mail-client/thunderbird-l10n-${PV}:0/stable"
fi
