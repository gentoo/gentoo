...
HOMEPAGE="https://www.urbanterror.info/ https://github.com/mickael9/ioq3"
...
src_compile() {
	# -fstrict-aliasing breaks network connections to any server.
	# Upstream bug is https://github.com/mickael9/ioq3/issues/40.
