...
multilib_src_configure() {
	local emesonargs=(
		...
		# Don't build docs twice
		-Dgtk_doc=$(meson_multilib_native_use gtk-doc)
		-Dintrospection=$(meson_multilib_native_use introspection)
		-Dvapi=$(meson_multilib_native_use vala)
	)
	meson_src_configure
}
