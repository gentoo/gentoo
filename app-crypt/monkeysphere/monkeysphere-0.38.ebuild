...
src_prepare()
{
	epatch "${FILESDIR}/${PN}-0.38-asprintf.patch" \
           "${FILESDIR}/${PN}-0.38-revert-executable-patch.patch"\
           "${FILESDIR}/${PN}-0.38-syssharedir-whitespace.patch"\
		   "${FILESDIR}/${PN}-0.36_default_shell.patch"\
