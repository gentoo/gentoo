...
# 0.12.x has breaking changes so avoid installing new server with old cli
DEPEND+="
	!!<net-mail/stalwart-cli-0.12.0
"
...
pkg_postinst() {
	ewarn "If you are upgrading from v0.11.x, this version includes "
