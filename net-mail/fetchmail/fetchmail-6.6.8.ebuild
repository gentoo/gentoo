...
IUSE="kerberos nls ntlm selinux socks ssl tk"
...
pkg_postinst() {
	...
	if use ntlm; then
		ewarn "Using NTLM support is discouraged upstream since November 2024"
		ewarn "It was the source of previous vulnerabilities (CVE-2026-94184)"
		ewarn "Only enable this if really needed"
	fi
