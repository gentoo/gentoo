...
IUSE="afs backup calalarm caps clamav http kerberos ldap \
	...
	sqlite ssl static-libs tcpd xapian"

CDEPEND="
	sys-libs/zlib:0=
	dev-libs/libpcre:3
	>=dev-libs/cyrus-sasl-2.1.17:2
	dev-libs/jansson
	dev-libs/icu:0=
	...
	snmp? ( >=net-analyzer/net-snmp-5.8-r3:0= )
	ssl? ( >=dev-libs/openssl-1.1.1g:0=[-bindist] )
	sqlite? ( dev-db/sqlite:3 )
	tcpd? ( >=sys-apps/tcp-wrappers-7.6.28
		snmp? ( net-analyzer/net-snmp:0=[tcpd=] )
		)
	xapian? ( >=dev-libs/xapian-1.4.14:0= )
"
# Tests now always required
DEPEND="${CDEPEND}
	dev-util/cunit
"
