...
src_prepare() {
	...
	epatch -p1 "${FILESDIR}"/${PN}-1.7.3-add-missing-gnome-shell-extension.patch
	# If LANG is undefined, build can fail (bug 537202)
	epatch "${FILESDIR}"/${PN}-1.7.3-undefined-LANG.patch
	# Fix urwid compat again
	epatch "${FILESDIR}"/${PN}-1.7.3-urwid-1.3.0.patch
	# Another compatibility patch from launchpad bug 1075399
	epatch "${FILESDIR}"/${PN}-1.7.3-bitrate-property.patch
