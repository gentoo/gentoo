...
SRC_URI="mirror://openbsd/OpenSSH/portable/${PARCH}.tar.gz
	...
	https://github.com/openssh/openssh-portable/commit/da6038bd5cd55eb212eb2aec1fc8ae79bbf76156.patch -> ${PN}-9.1_p1-getentropy.patch
	https://github.com/openssh/openssh-portable/commit/6283f4bd83eee714d0f5fc55802eff836b06fea8.patch -> ${PN}-9.1_p1-sandbox-writev.patch
"
...
pkg_postinst() {
	...
	for old_ver in ${REPLACING_VERSIONS}; do
		...
		if ver_test "${old_ver}" -lt "9.1_p1-r4" && systemd_is_booted; then
			ewarn "From openssh-9.1_p1-r4 the supplied systemd unit file defaults to"
