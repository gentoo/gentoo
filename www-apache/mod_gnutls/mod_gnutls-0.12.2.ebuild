...
inherit autotools apache-module depend.apache flag-o-matic python-any-r1
...
SRC_URI="https://github.com/airtower-luna/mod_gnutls/archive/refs/tags/${PN}/${PV}.tar.gz -> ${P}.gh.tar.gz"
...
RDEPEND=">=net-libs/gnutls-3.3.0:=[pkcs11]"
DEPEND="
	${RDEPEND}
	test? (
