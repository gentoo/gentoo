...
LICENSE="
	...
	angrylion? ( XMAME )
	rust? ( ISC Unicode-DFS-2016 )
"
SLOT="0"
IUSE="angrylion asm discord rust"
REQUIRED_USE="asm? ( || ( amd64 arm arm64 x86 ) )"

DEPEND="
	rust? ( dev-libs/libusb:1 )
	dev-libs/hidapi:=
	dev-qt/qtbase:6[gui,widgets,vulkan]
	dev-qt/qtsvg:6
	media-libs/freetype:=
	media-libs/libpng:=
	media-libs/libsamplerate
	media-libs/libsdl2[haptic,joystick,sound,vulkan]
	media-libs/speexdsp
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DNO_ASM=$(usex asm OFF ON)
		-DNO_RUST=$(usex rust OFF ON)
		-DPORTABLE_INSTALL=OFF
		-DUPDATER=OFF
		-DUSE_ANGRYLION=$(usex angrylion)
		-DUSE_CCACHE=OFF
