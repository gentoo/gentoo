...
pkg_postinst() {
	...
	optfeature "CD audio decoding" media-sound/cdparanoia
	optfeature "mp3 decoding" media-sound/mpg123
	optfeature "misc audio format decoding" media-video/ffmpeg
}
