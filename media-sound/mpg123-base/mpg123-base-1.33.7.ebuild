...
MY_PN="mpg123"
MY_P="${MY_PN}-${PV}"
VERIFY_SIG_OPENPGP_KEY_PATH=/usr/share/openpgp-keys/thomasorgis.asc
inherit flag-o-matic toolchain-funcs libtool multilib-minimal verify-sig

DESCRIPTION="Realtime MPEG 1.0/2.0/2.5 audio player for layers 1, 2 and 3"
HOMEPAGE="https://www.mpg123.org/"
SRC_URI="
	https://downloads.sourceforge.net/${MY_PN}/${MY_P}.tar.bz2
	https://www.mpg123.org/download/${MY_P}.tar.bz2
	verify-sig? (
		https://downloads.sourceforge.net/${MY_PN}/${MY_P}.tar.bz2.sig
		https://www.mpg123.org/download/${MY_P}.tar.bz2.sig
	)
"
S="${WORKDIR}/${MY_P}"
...
BDEPEND="
	dev-build/libtool
	virtual/pkgconfig
	verify-sig? ( sec-keys/openpgp-keys-thomasorgis )
"
