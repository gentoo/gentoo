...
if [[ "${PV}" == 9999* ]]; then
	...
	SRC_URI="
		...
		https://codeberg.org/G-two/vendor/raw/branch/main/${P}-vendor.tar.xz
...
LICENSE="Apache-2.0"
# deps
LICENSE+=" BSD MIT CC0-1.0"
SLOT="0"

IUSE='events-handlers-exec security cloudflare'
RESTRICT="test"
...
src_unpack() {
	...
	use cloudflare && { MOOMODULES[cloudflare]="github.com/caddy-dns/cloudflare" || die ; }
