...
# $Header: /var/cvsroot/gentoo-x86/dev-texlive/texlive-humanities/texlive-humanities-2015.ebuild,v 1.1 2015/07/16 09:16:15 aballier Exp $

EAPI="5"

TEXLIVE_MODULE_CONTENTS="bibleref bibleref-lds bibleref-mouth bibleref-parse covington diadia dramatist dvgloss ecltree edfnotes ednotes eledform eledmac expex gb4e gmverse jura juraabbrev juramisc jurarsp ledmac leipzig lexikon lexref linguex liturg metrix parallel parrun phonrule plari play poemscol poetrytex qobitree qtree rrgtrees rtklage screenplay sides stage textglos thalie tree-dvips verse xyling collection-humanities
"
