...
python_prepare_all() {
	# The sentries.org mirror has already been replaced upstream. See
	# https://github.com/rseichter/fangfrisch/commit/ef951742e7fd3fa0707befc5b3d384332788c3b1
	sed -i -e 's/mirror\.sentries\.org/mirror.seichter.de/' \
		src/fangfrisch/config/sanesecurity.py "${HTML_DOCS[@]}" || die
