...
SRC_URI+=" https://dev.gentoo.org/~mattst88/distfiles/${PN}-46.2-patchset.tar.xz"
...
SLOT="2"
IUSE="+bluetooth +cups debug elogind +gnome-online-accounts +ibus input_devices_wacom kerberos +location networkmanager systemd test wayland"
RESTRICT="!test? ( test )"
REQUIRED_USE="
	^^ ( elogind systemd )
...
src_configure() {
	...
	local emesonargs=(
		...
		-Dlocation-services=$(usex location enabled disabled)
