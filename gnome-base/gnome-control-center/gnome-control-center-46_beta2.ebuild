...
# WIP SRC_URI+=" https://dev.gentoo.org/~mattst88/distfiles/${PN}-45.0-patchset.tar.xz"
...
src_configure() {
	local emesonargs=(
		#WIP $(meson_use bluetooth)
		#WIP -Dcups=$(usex cups enabled disabled)
		-Ddocumentation=true # manpage
		#WIP -Dgoa=$(usex gnome-online-accounts enabled disabled)
		$(meson_use ibus)
		#WIP -Dkerberos=$(usex kerberos enabled disabled)
		#WIP $(meson_use networkmanager network_manager)
		-Dprivileged_group=wheel
		-Dsnap=false
		$(meson_use test tests)
		#WIP $(meson_use input_devices_wacom wacom)
