...
SRC_URI+=" https://www.gentoo.org/assets/img/logo/gentoo-horizontal.svg -> gentoo-gnome-control-center.svg"
LICENSE="GPL-2+"
SLOT="2"
...
src_prepare() {
	...
	# resize the image and move it to WORKDIR
	sed 's/width="100%" height="100%"/width="30%" height="30%"/' "${DISTDIR}"/gentoo-gnome-control-center.svg > "${WORKDIR}"/gentoo-gnome-control-center.svg
}
...
src_configure() {
	local emesonargs=(
		...
		-Ddistributor_logo=/usr/share/pixmaps/gentoo-gnome-control-center.svg
		-Ddark_mode_distributor_logo=/usr/share/pixmaps/gentoo-gnome-control-center.svg
	)
	meson_src_configure
}
...
src_install() {
	...
	doins "${WORKDIR}/gentoo-gnome-control-center.svg"
}
