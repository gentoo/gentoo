...
DEPEND="
	...
	>=gnome-base/gnome-settings-daemon-49.0[colord,input_devices_wacom?]
...
PATCHES=(
	...
	"${FILESDIR}/0001-exherbo-optionalise-kerberos-based-authentication-49.3.patch"
	"${FILESDIR}/0002-exherbo-optionalise-cups-support-49.4.patch"
	"${FILESDIR}/0003-optionalise-nm-bluetooth-wacom-49.3.patch"
	"${FILESDIR}/0004-optionalise-gnome-online-accounts-49.4.patch"
	"${FILESDIR}/0005-replace-absolute-paths-49.4.patch"
)
