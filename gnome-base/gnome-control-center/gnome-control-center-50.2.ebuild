...
IUSE="+bluetooth +cups debug elogind +gnome-online-accounts +ibus input_devices_wacom kerberos +geolocation networkmanager parental-controls systemd test"
REQUIRED_USE="
	^^ ( elogind systemd )
...
src_configure() {
	local emesonargs=(
		...
		$(meson_use parental-controls malcontent)
