...
IUSE="afp archive bluray cdda cdr elogind fuse google keyring gnome-online-accounts gphoto2 +http ios onedrive mtp nfs policykit samba systemd test +udev udisks zeroconf"
RESTRICT="!test? ( test )"
