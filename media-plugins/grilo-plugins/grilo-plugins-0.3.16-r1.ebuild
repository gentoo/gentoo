...
IUSE="daap chromaprint flickr freebox gnome-online-accounts localsearch lua test thetvdb upnp-av +youtube"
RESTRICT="!test? ( test )"
...
RDEPEND="
	...
	localsearch? ( app-misc/tinysparql:3= )
...
src_configure() {
	local emesonargs=(
		...
		-Denable-tmdb=yes
		-Denable-tracker=no
		-Denable-tracker3=$(usex localsearch yes no)
