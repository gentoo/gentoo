...
IUSE="daap chromaprint flickr freebox gnome-online-accounts lua soup3 test thetvdb tracker upnp-av +youtube"
RESTRICT="!test? ( test )"
REQUIRED_USE="
...
RDEPEND="
	...
	soup3? (  net-libs/libsoup:3.0 )
	!soup3? ( net-libs/libsoup:2.4 )
	dev-libs/libxml2:2
	flickr? (
		net-libs/liboauth
...
src_configure() {
	local emesonargs=(
		...
		-Denable-opensubtitles=$(usex soup3 no yes)  # Requires libsoup-2
