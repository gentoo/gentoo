...
# original SRC_URI is now protected with https://anubis.techaro.lol/ so portage distfile download does not work
#SRC_URI="https://www.gen2vdr.de/wirbel/wirbelscan/vdr-wirbelscan-${PV}.tgz"
# switch to github repo
SRC_URI="https://github.com/wirbel-at-vdr-portal/wirbelscan-dev/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/wirbelscan-dev-${PV}"
