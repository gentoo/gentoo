...
IUSE="aac a52 alsa cdda dts dv dvb dvd ffmpeg flac gtk http jack lame libass libvisual mp3 modplug mpeg ogg opus oss pulseaudio taglib theora v4l vaapi vcd vorbis vpx wavpack X x264"
...
RDEPEND="
	...
	gtk? ( >=media-plugins/gst-plugins-gtk-${PV}:1.0[${MULTILIB_USEDEP}] )
