...
GITHASH="366a0ce9a8defb50f048983b4ff6c4da22fb19d0"
SRC_URI="https://github.com/vdr-projects/vdr-plugin-streamdev/archive/${GITHASH}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/vdr-plugin-streamdev-${GITHASH}"
