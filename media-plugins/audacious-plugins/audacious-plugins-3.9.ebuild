...
SRC_URI="!gtk3? ( http://distfiles.audacious-media-player.org/${MY_P}.tar.bz2 )
	 gtk3? ( https://github.com/audacious-media-player/audacious-plugins/archive/${MY_P}-gtk3.tar.gz )"
...
src_configure() {
	...
	# gtk3 sources comes from git tarball so they need autoreconf
	use gtk3 && autoreconf
