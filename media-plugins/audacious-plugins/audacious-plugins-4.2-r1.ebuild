...
# https://redmine.audacious-media-player.org/issues/1181
# https://github.com/audacious-media-player/audacious-plugins/pull/110
PATCHES="${FILESDIR}/${P}-make-ogg-flac-support-optional.patch"
