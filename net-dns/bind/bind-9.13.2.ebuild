...
inherit python-r1 autotools toolchain-funcs flag-o-matic multilib db-use user systemd
...
IUSE="-berkdb +caps dlz dnstap doc dnsrps fixed-rrset geoip gssapi idn ipv6 json ldap libressl lmdb mysql odbc postgres python rpz selinux ssl static-libs +threads xml +zlib"
