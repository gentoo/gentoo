...
inherit cmake-utils python-r1 virtualx distutils-r1
...
SRC_URI="https://download.qt.io/official_releases/QtForPython/PySide2-${PV}-src/${MY_P}.tar.xz"
...
REQUIRED_USE="
	...
	svg? ( widgets )
	testlib? ( widgets )
	webengine? ( quick location widgets? ( gui network printsupport webchannel ) )
	websockets? ( network )
	widgets? ( gui )
	x11extras? ( gui )
"
