...
distutils_enable_sphinx docs/sphinx dev-python/sphinx-autodoc-typehints dev-python/sphinx-rtd-theme
distutils_enable_tests pytest

src_prepare() {
	# Remove extra options for pytest.
	sed -i '/[tool:pytest]/,/^$/ { s/addopts.*// }' setup.cfg || die
