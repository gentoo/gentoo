...
python_test() {
	local EPYTEST_IGNORE=(
		...
		# Requires sentence-transformers which requires sci-ml/transformers and other pytorch related packages.
		# This is more pain than its worth as the packages as of 16/04/2025 don't have python3.13 support and
		# don't support multiple python versions.
		# https://gitweb.gentoo.org/repo/gentoo.git/commit/?id=ee295a13a4a5dc9090726aef728a81431e51e71f
