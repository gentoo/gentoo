...
python_prepare_all() {
	...
	# Raise jedi dep limit from 0.18.0 -> 0.19.0
	sed -i -e 's/jedi>=0.17.2,<0.18.0/jedi>=0.17.2,<0.19.0/' setup.py || die
	sed -i -e 's/jedi<0.18.0,/jedi<0.19.0,/' python_language_server.egg-info/requires.txt || die
