...
python_test() {
	local EPYTEST_DESELECT=(
		# missing file: https://github.com/scikit-hep/awkward/issues/4178
		tests/test_4056_cuda_compute_signature_consistency.py::test_cuda_compute_wrappers_match_kernel_spec
	)
