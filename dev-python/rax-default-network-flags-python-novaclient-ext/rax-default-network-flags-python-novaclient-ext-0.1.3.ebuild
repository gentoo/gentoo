...
# $Header: /var/cvsroot/gentoo-x86/dev-python/rax-default-network-flags-python-novaclient-ext/rax-default-network-flags-python-novaclient-ext-0.1.3.ebuild,v 1.3 2015/04/08 08:05:00 mgorny Exp $
