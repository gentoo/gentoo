...
RDEPEND="
	...
	pyside6? ( dev-python/pyside:6[gui,widgets,opengl=,svg=,${PYTHON_USEDEP}] )
	pyqt6? ( dev-python/pyqt6[gui,widgets,opengl=,svg=,${PYTHON_USEDEP}] )
"
BDEPEND="
	test? (
		dev-python/h5py[${PYTHON_USEDEP}]
		pyside6? ( dev-python/pyside:6[testlib,tools,${PYTHON_USEDEP}] )
...
EPYTEST_DESELECT=(
	...
	tests/exporters/test_svg.py::test_simple
