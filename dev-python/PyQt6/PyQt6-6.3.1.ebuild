...
SLOT="0"
KEYWORDS="~amd64"
# currently keeping defaults in sync with qtbase, but not too
# many given each builds relatively slowly (subject to change
# if something is needed by most consumers)
IUSE="
