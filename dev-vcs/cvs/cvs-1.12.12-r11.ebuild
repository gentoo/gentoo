...
# cvs-format.el is not installed into emacs site-lisp because it
# clobbers the normal C indentations.
DOCS=( BUGS cvs-format.el ChangeLog{,.zoo} DEVEL-CVS FAQ HACKING MINOR-BUGS NEWS PROJECTS README TESTS TODO )
