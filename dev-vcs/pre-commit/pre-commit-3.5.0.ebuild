...
EPYTEST_DESELECT=(
	# Require a boatload of dependencies (e.g. Conda, Go, R and more) in order to run
	...
	# Fails if pre-commit is already installed Bug #894502
