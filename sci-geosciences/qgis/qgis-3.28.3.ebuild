...
inherit cmake python-single-r1 virtualx xdg desktop
...
src_install() {
	...
	newicon -s 512 "${S}/images/icons/qgis-icon-512x512.png" qgis.png
	make_desktop_entry /usr/bin/qgis QGIS qgis Graphics
