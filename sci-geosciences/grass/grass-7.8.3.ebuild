...
inherit autotools desktop eapi7-ver python-single-r1 toolchain-funcs wxwidgets xdg flag-o-matic
...
src_compile() {
	# Debug
	append-cflags -ggdb -Wall -Werror-implicit-function-declaration
