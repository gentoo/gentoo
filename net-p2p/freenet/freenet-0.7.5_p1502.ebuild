...
inherit flag-o-matic java-pkg-2 java-pkg-simple systemd toolchain-funcs verify-sig
...
PATCHES=(
	"${FILESDIR}/freenet-0.7.5_p1502-ignore-failing-tests.patch"
	"${FILESDIR}/freenet-0.7.5_p1502-NativeThread.patch"
)
...
src_unpack() {
	...
	mv "${WORKDIR}/contrib-${FEV}/NativeThread" "${S}" || die "move NativeThread"
}
