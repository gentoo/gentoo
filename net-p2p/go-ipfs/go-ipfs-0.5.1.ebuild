...
EGO_SUM=(
	...
	"github.com/btcsuite/btcd v0.0.0-20190629003639-c26ffa870fd8/go.mod"
	...
	"github.com/ipfs/go-bitswap v0.2.13/go.mod"
	...
	"github.com/ipfs/go-ds-flatfs v0.4.4/go.mod"
	...
	"github.com/ipfs/go-fs-lock v0.0.4/go.mod"
	"github.com/ipfs/go-graphsync v0.0.5"
	"github.com/ipfs/go-graphsync v0.0.5/go.mod"
	...
	"github.com/ipfs/go-ipfs-cmds v0.2.2/go.mod"
	...
	"github.com/ipfs/go-ipfs-files v0.0.4/go.mod"
	...
	"github.com/ipfs/go-merkledag v0.2.4/go.mod"
	...
	"github.com/ipfs/go-mfs v0.1.1/go.mod"
	...
	"github.com/ipfs/go-unixfs v0.2.2-0.20190827150610-868af2e9e5cb/go.mod"
	...
	"github.com/ipfs/interface-go-ipfs-core v0.2.7/go.mod"
	"github.com/ipld/go-car v0.1.0"
	"github.com/ipld/go-car v0.1.0/go.mod"
	"github.com/ipld/go-ipld-prime v0.0.2-0.20191108012745-28a82f04c785"
	"github.com/ipld/go-ipld-prime v0.0.2-0.20191108012745-28a82f04c785/go.mod"
	"github.com/ipld/go-ipld-prime-proto v0.0.0-20191113031812-e32bd156a1e5"
	"github.com/ipld/go-ipld-prime-proto v0.0.0-20191113031812-e32bd156a1e5/go.mod"
	...
	"github.com/jbenet/go-is-domain v1.0.3/go.mod"
	...
	"github.com/libp2p/go-eventbus v0.0.3/go.mod"
	...
	"github.com/libp2p/go-libp2p v0.2.1/go.mod"
	...
	"github.com/libp2p/go-libp2p v0.8.2/go.mod"
	...
	"github.com/libp2p/go-libp2p-connmgr v0.2.1/go.mod"
	...
	"github.com/libp2p/go-libp2p-core v0.0.9/go.mod"
	...
	"github.com/libp2p/go-libp2p-kad-dht v0.7.11/go.mod"
	"github.com/libp2p/go-libp2p-kbucket v0.4.1"
	"github.com/libp2p/go-libp2p-kbucket v0.4.1/go.mod"
	...
	"github.com/libp2p/go-libp2p-peerstore v0.1.2/go.mod"
	...
	"github.com/libp2p/go-libp2p-pubsub v0.2.5/go.mod"
	"github.com/libp2p/go-libp2p-pubsub v0.2.7"
	"github.com/libp2p/go-libp2p-pubsub v0.2.7/go.mod"
	"github.com/libp2p/go-libp2p-pubsub-router v0.2.1"
	"github.com/libp2p/go-libp2p-pubsub-router v0.2.1/go.mod"
	"github.com/libp2p/go-libp2p-quic-transport v0.3.7"
	"github.com/libp2p/go-libp2p-quic-transport v0.3.7/go.mod"
	...
	"github.com/libp2p/go-libp2p-secio v0.1.1/go.mod"
	...
	"github.com/libp2p/go-libp2p-swarm v0.1.1/go.mod"
	...
	"github.com/multiformats/go-multihash v0.0.6/go.mod"
	...
	"go4.org v0.0.0-20200104003542-c7e774b10ea0/go.mod"
