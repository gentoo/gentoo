...
src_install() {
	...
	insinto /usr/lib/wireshare
	doins nativelibs/linux/libjdic.so
	doins nativelibs/linux/libtorrent-wrapper.so
	doins nativelibs/linux/libtorrent-wrapper64.so
	doins nativelibs/linux/libtray.so
}
