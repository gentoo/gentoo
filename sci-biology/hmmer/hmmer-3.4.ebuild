...
src_configure() {
	...
	# Force '-O3' as it is set as default in the upstream source
	replace-flags '-O?' '-O3'

	# When using bundled gsl, march optimizations might result in test fails
	# (possibly due to violation of tolerance constraints)
