...
SRC_URI="https://download.sourceforge.net/open${PN}/RasMol/RasMol_2.7.5/${P}-${VERS}.tar.gz"
#SRC_URI="https://download.sourceforge.net/open${PN}/RasMol/RasMol_2.7.5/RasMol.tar.gz"
