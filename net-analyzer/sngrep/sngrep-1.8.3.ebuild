...
PATCHES=(
	# Fix implicit sng_strncpy()
	"${FILESDIR}/${PN}-1.8.3-expose-sng_strncpy.patch"
	# Fix too many arguments for format [-Wformat-extra-args] in curses/ui_call_flow.c
	"${FILESDIR}/${PN}-1.8.3-fortify.patch"
)
