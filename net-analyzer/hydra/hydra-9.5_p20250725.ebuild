...
HASH_COMMIT="ba4cfe13778a7f76d8eeb948d04de05f641ff0aa"
SRC_URI="https://github.com/vanhauser-thc/thc-hydra/archive/${HASH_COMMIT}.tar.gz -> ${P}.tar.gz"
S="${WORKDIR}/thc-${PN}-${HASH_COMMIT}"
