...
inherit autotools fcaps linux-info python-single-r2 systemd
...
RDEPEND="
	...
	python? (
		...
		mysql? (
			|| (
				$(python_gen_cond_dep 'dev-python/mysqlclient[${PYTHON_USEDEP}]')
				$(python_gen_cond_dep 'dev-python/mysql-python[${PYTHON_USEDEP}]')
			)
		)
