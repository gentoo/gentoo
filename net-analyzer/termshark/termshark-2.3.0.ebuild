...
EGO_SUM=(
	...
	"github.com/adam-hanna/arrayOperations v0.2.6/go.mod"
	...
	"github.com/araddon/dateparse v0.0.0-20210207001429-0eec95c9db7e/go.mod"
	...
	"github.com/gcla/deep v1.0.2/go.mod"
	"github.com/gcla/gowid v1.2.1-0.20210902230020-c4910818c6b3"
	"github.com/gcla/gowid v1.2.1-0.20210902230020-c4910818c6b3/go.mod"
	"github.com/gcla/tail v1.0.1-0.20190505190527-650e90873359"
	"github.com/gcla/tail v1.0.1-0.20190505190527-650e90873359/go.mod"
	"github.com/gcla/tcell v1.1.2-0.20200927150251-decc2045f510"
	"github.com/gcla/tcell v1.1.2-0.20200927150251-decc2045f510/go.mod"
	"github.com/gcla/term v0.0.0-20191015020247-31cba2f9f402"
	"github.com/gcla/term v0.0.0-20191015020247-31cba2f9f402/go.mod"
	...
	"github.com/guptarohit/asciigraph v0.4.1/go.mod"
	...
	"github.com/mreiferson/go-snappystream v0.2.3/go.mod"
	...
	"github.com/psanford/wormhole-william v1.0.6-0.20210402190004-049df45b8d5a/go.mod"
	...
	"github.com/tevino/abool v1.2.0/go.mod"
	...
	"golang.org/x/sys v0.0.0-20210108172913-0df2131ae363/go.mod"
	...
	"salsa.debian.org/vasudev/gospake2 v0.0.0-20180813171123-adcc69dd31d5/go.mod"
)
