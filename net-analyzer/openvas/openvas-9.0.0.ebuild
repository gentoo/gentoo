...
DEPEND="
        ...
        >=net-analyzer/openvas-manager-7.0.4
        gsa? ( >=net-analyzer/greenbone-security-assistant-7.0.4 )
        ...
        extras? (
                ...
                >=net-analyzer/openvas-manager-7.0.4[extras]
                >=net-analyzer/greenbone-security-assistant-7.0.4[extras]
                app-doc/doxygen[dot]
                app-doc/xmltoman
