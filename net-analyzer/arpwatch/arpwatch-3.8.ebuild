...
PATCHES=(
	...
	# not sent upstream, experimental fixes
	"${FILESDIR}"/0003-arpwatch.c-Wunused-result-fix.patch
	"${FILESDIR}"/0004-dns.c-drop-deprecated.patch
	# See bug https://bugs.gentoo.org/783195 for details
	"${FILESDIR}"/0005-Use-correct-datadir.patch
	"${FILESDIR}"/0006-Use-correct-paths-in-update-ethercodes.patch
)
