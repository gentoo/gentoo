...
src_install() {
	...
	einfo "Renaming gstat -> fbstat"
	mv bin/gstat bin/fbstat || die "failed to rename gstat -> fbstat"

	dobin bin/{fb_config,fbsql,fbstat,fbsvcmgr,fbtracemgr,gbak,gfix,gpre,gsec,gsplit,nbackup,qli}
