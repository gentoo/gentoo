...
SRC_URI="https://github.com/dbcli/${PN}/archive/v${PV/_p*/}.tar.gz -> ${P/_p*/}.tar.gz"
LICENSE="BSD MIT"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="ssh test"
...
RDEPEND="$(python_gen_cond_dep '
	...
	<dev-python/sqlparse-0.5.0[${PYTHON_MULTI_USEDEP}]
...
PATCHES=( "${FILESDIR}/mycli-1.21.1-fix-test-install.patch"
		  "${FILESDIR}/mycli-sqlparse-0.4.patch"
		  "${FILESDIR}/mycli-PR900-ported.patch")
S="${WORKDIR}/${PN}-${PV/_p*/}"
...
python_test() {
	pytest --capture=sys \
		...
		--ignore=mycli/packages/paramiko_stub
}
