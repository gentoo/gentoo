...
PATCHES=(
	"${FILESDIR}"/${PN}-${PV}-unbundle-contrib.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-MeCab.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-brotli.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-bzip2.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-c-ares.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-crc32c.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-cyrus-sasl.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-double-conversion.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-isa-l.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-jwt-cpp.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-krb5.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-libarchive.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-libcpuid.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-libuv.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-libxml2.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-lz4.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-magic_enum.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-nlohmann-json.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-numactl.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-openldap.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-pocketfft.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-postgres.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-rapidjson.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-simdjson.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-simdutf.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-sparsehash-c11.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-sqlite-amalgamation.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-vectorscan.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-xz.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-zlib-ng.patch
	"${FILESDIR}"/${PN}-${PV}-unbundle-zstd.patch
)
...
src_unpack() {
	default
	local submodule name repo sha
	for submodule in "${CH_SUBMODULES[@]}"; do
		read -r name repo sha <<<"${submodule}"
		repo=${repo##*/}
...
src_test() {
	...
	local IFS=:
	"${BUILD_DIR}"/src/unit_tests_dbms --gtest_filter="-${skip[*]}" || die
}
