...
inherit gnome2 eutils flag-o-matic toolchain-funcs python-single-r1 cmake-utils
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-6.3.9-gcc7-string-buffer-padding.patch"
)
...
src_configure() {
	...
	# gcc7 not working yet ootb; act more like gcc6
	tc-is-gcc && [[ $(gcc-major-version) -ge 7 ]] && \
		append-flags -Wno-error=implicit-fallthrough -Wno-error=strict-aliasing
