...
declare -g -r -A ZBS_DEPENDENCIES=(
	...
	[N-V-__8AANodAwDnyHwhlOv5cVRn2rx_dTvija-wy5YtTw1B.tar.gz]='https://deps.files.ghostty.org/ghostty-themes-20250915-162204-b1fe546.tgz'
...
PATCHES=(
	"${FILESDIR}"/${PN}-1.2.0-build-add-a-step-for-only-building-terminfo.patch
)
