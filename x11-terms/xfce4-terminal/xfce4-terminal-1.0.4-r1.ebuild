...
RDEPEND="
	...
	>=xfce-base/libxfce4ui-4.19:=[gtk3(+)]
...
src_prepare() {
	subst_args=(xfce_gtk_menu_append_sep{e,a}rator)
	sed -E -i "s#${subst_args[0]}#${subst_args[1]}#" terminal/terminal-window{,-dropdown}.c || die
	default
}
