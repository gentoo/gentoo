...
src_install () {
	...
	# disable vulnerable pythonscript.py, bug #677248
	mv "${ED}${INSTDIR}/program/pythonscript.py" "${ED}${INSTDIR}/program/pythonscript.py.disabled" || die
}
...
pkg_postinst() {
	...
	elog "${INSTDIR}/program/pythonscript.py has been renamed to"
	elog "pythonscript.py.disabled due to a security vulnerability (CVE-2018-16858)"
	elog "If you require running python scripts from ODF documents, rename it back."
}
