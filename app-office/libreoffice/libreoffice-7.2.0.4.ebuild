...
PATCHES=(
	...
	# Only necessary for <skia-m94 bug 733102
	"${FILESDIR}/${PN}-7.2.0.4-skia-m90-with-freetype-2.11.patch"
	# Fix CMIS compilation (2021-09-07).
	"${FILESDIR}/${PN}-7.2.0.4-gdrive_support_w_oauth-and-drive.patch"
)
