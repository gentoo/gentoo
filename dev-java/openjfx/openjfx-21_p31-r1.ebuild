...
SRC_URI="https://github.com/openjdk/jfx/archive/refs/tags/${MY_PV}.tar.gz -> ${P}.tar.gz"
...
BDEPEND="
	dev-java/gradle-bin:${EGRADLE_VER}
	${DEPEND}
"
...
egradle() {
	local GRADLE_HOME="$(realpath $(dirname $(realpath $(type -p gradle-bin-${EGRADLE_VER})))/..)"
