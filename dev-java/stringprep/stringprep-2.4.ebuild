...
JAVA_TEST_RESOURCE_DIRS=( stringprep/src/test/resources )
JAVA_TEST_SRC_DIR=( {string,name,sasl}prep/src/test/java )
...
src_compile() {
	...
	for module in stringprep nameprep saslprep; do
		...
		JAVA_INTERMEDIATE_JAR_NAME="com.ongres.${module}"
		JAVA_RELEASE_SRC_DIRS=( ["9"]="${module}/src/main/java9" )
