...
# We need some of the test classes and they are not part of commons-collections.jar
...
src_test() {
	...
	# We skip 2 more test classes conditionally which have failures with Java 21 "using pattern" with '\u202f'
