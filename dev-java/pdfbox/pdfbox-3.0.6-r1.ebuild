...
DEPEND="
	...
	test? (
		...
		>=dev-java/log4j-api-2.25.3:0
		>=dev-java/log4j-core-2.25.3:0
		>=dev-java/log4j-jcl-2.25.3:0
...
JAVA_TEST_GENTOO_CLASSPATH="asm byte-buddy diffutils jai-imageio-core jai-imageio-jpeg2000
	jbig2-imageio junit-5 log4j-api log4j-core log4j-jcl mockito"
