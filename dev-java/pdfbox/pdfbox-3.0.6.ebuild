...
L4J="2.25.2" # dev-java/log4j-* need updates
...
SRC_URI="mirror://apache/${PN}/${PV}/${P}-src.zip
	test? (
		...
		https://repo1.maven.org/maven2/org/apache/logging/log4j/log4j-api/${L4J}/log4j-api-${L4J}.jar
		https://repo1.maven.org/maven2/org/apache/logging/log4j/log4j-core/${L4J}/log4j-core-${L4J}.jar
...
JAVA_TEST_GENTOO_CLASSPATH="asm byte-buddy diffutils jai-imageio-core jai-imageio-jpeg2000 jbig2-imageio junit-5 mockito"
...
src_test() {
	...
	JAVA_GENTOO_CLASSPATH_EXTRA+=":${DISTDIR}/log4j-api-${L4J}.jar"
	JAVA_GENTOO_CLASSPATH_EXTRA+=":${DISTDIR}/log4j-core-${L4J}.jar"
