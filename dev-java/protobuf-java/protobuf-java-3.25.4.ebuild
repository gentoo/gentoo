...
# And we build artifact 3.25.4 from the 25.4 tarball in order to allow sharing the tarball with
# dev-libs/protobuf.
MY_PV3="${PV#3.}"
MY_PV="${MY_PV3/_rc/-rc}"
...
src_prepare() {
	...
	# https://github.com/protocolbuffers/protobuf/blob/v25.4/java/core/pom.xml#L43-L62
	PROTOS=(  $(sed \
	...
	# https://github.com/protocolbuffers/protobuf/blob/v25.4/java/core/generate-sources-build.xml
	...
	# https://github.com/protocolbuffers/protobuf/blob/v25.4/java/core/generate-test-sources-build.xml
...
src_test() {
	# https://github.com/protocolbuffers/protobuf/blob/v25.4/java/core/pom.xml#L63-L71
