...
src_prepare() {
	...
	sed -i \
		-e '$asrc/google/protobuf/edition_unittest.proto' \
		-e '$asrc/google/protobuf/unittest_delimited.proto' \
		-e '$asrc/google/protobuf/unittest_delimited_import.proto' \
		-e '$asrc/google/protobuf/unittest_import_option.proto' \
		-e '$ajava/core/src/test/proto/com/google/protobuf/large_open_enum.proto' \
		test-sources-build-1 || die
}
