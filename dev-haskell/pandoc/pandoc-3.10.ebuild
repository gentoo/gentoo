...
IUSE="embed-data-files +http"

RDEPEND=">=dev-haskell/aeson-2.0.1.0:=[profile?] <dev-haskell/aeson-2.4:=[profile?]
	>=dev-haskell/aeson-pretty-0.8.9:=[profile?] <dev-haskell/aeson-pretty-0.9:=[profile?]
	>=dev-haskell/asciidoc-0.1.0.3:=[profile?] <dev-haskell/asciidoc-0.2:=[profile?]
	...
	>=dev-haskell/citeproc-0.13.0.1:=[profile?] <dev-haskell/citeproc-0.14:=[profile?]
	>=dev-haskell/commonmark-0.3:=[profile?] <dev-haskell/commonmark-0.4:=[profile?]
	>=dev-haskell/commonmark-extensions-0.2.7:=[profile?] <dev-haskell/commonmark-extensions-0.3:=[profile?]
	>=dev-haskell/commonmark-pandoc-0.3:=[profile?] <dev-haskell/commonmark-pandoc-0.4:=[profile?]
	...
	>=dev-haskell/djot-0.1.4:=[profile?] <dev-haskell/djot-0.2:=[profile?]
	...
	>=dev-haskell/texmath-0.13.1.2:=[profile?] <dev-haskell/texmath-0.14:=[profile?]
	...
	>=dev-haskell/typst-0.10:=[profile?] <dev-haskell/typst-0.11:=[profile?]
	...
	>=dev-lang/ghc-9.6.2:=
	http? ( >=dev-haskell/crypton-connection-0.3.1:=[profile?] <dev-haskell/crypton-connection-0.5:=[profile?]
		>=dev-haskell/crypton-x509-system-1.6.7:=[profile?] <dev-haskell/crypton-x509-system-1.10:=[profile?]
		>=dev-haskell/http-client-0.4.30:=[profile?] <dev-haskell/http-client-0.8:=[profile?]
		>=dev-haskell/http-client-tls-0.2.4:=[profile?] <dev-haskell/http-client-tls-0.5:=[profile?]
		>=dev-haskell/network-2.6:=[profile?] <dev-haskell/network-3.3:=[profile?]
		>=dev-haskell/tls-2.0.1:=[profile?] <dev-haskell/tls-2.5:=[profile?] )
"
DEPEND="${RDEPEND}
