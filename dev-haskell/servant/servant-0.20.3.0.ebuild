...
CABAL_CHDEPS=(
	'base          >= 4.16.4.0 && <4.22' 'base          >= 4.15.1.0 && <4.22'
	)
...
RDEPEND=">=dev-haskell/aeson-1.4.1.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/generics-sop-0.5.1:=[profile?] <dev-haskell/generics-sop-0.6:=[profile?]
	...
	>=dev-haskell/quickcheck-2.12.6.1:=[profile?] <dev-haskell/quickcheck-2.17:=[profile?]
