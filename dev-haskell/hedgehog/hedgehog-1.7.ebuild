...
RDEPEND=">=dev-haskell/ansi-terminal-0.6:=[profile?] <dev-haskell/ansi-terminal-1.2:=[profile?]
	...
	>=dev-haskell/lifted-async-0.7:=[profile?] <dev-haskell/lifted-async-0.12:=[profile?]
