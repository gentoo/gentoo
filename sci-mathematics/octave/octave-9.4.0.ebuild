...
LICENSE="CC0-1.0 GPL-3+ public-domain || ( GPL-3 GPL-2 LGPL-3 )"
SLOT="0/${PV}"
KEYWORDS="~amd64 ~arm ~arm64 ~hppa ~ppc ~ppc64 ~riscv ~x86 ~amd64-linux ~x86-linux"

IUSE="+bzip2 curl doc fftw +glpk gnuplot gui hdf5 imagemagick java json klu portaudio
...
src_compile() {
	...
	use java && pax-mark m "${S}/src/.libs/octave-cli"
}
